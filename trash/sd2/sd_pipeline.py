...
from diffusers.pipelines.stable_difussion.pipeline_output import StableDiffusionPipelineOutput
from diffusers.pipelines.stable_difussion.safety_checker import StableDiffusionSafetyChecker
