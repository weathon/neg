...
class FluxAttnProcessor2_0:
    ...
    def __call__(
        ...
        self.img2text_attention_map = torch.einsum("bhqd,bhkd->bhqk", encoder_hidden_states_query_proj[:,:,0:1], key[:,:,encoder_hidden_states_query_proj.shape[2]:])
        self.img2text_attention_map = self.img2text_attention_map / math.sqrt(head_dim)
        self.img2text_attention_map = self.img2text_attention_map.softmax(dim=-1).mean(dim=-2)
