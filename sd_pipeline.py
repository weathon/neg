        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                if self.do_classifier_free_guidance:
                    ...
                    # noise_pred = (self.guidance_scale * (noise_pred_text - uncon_noise_pred))
                    ...
                    # original_norm = torch.linalg.norm(noise_pred, keepdim=True)
                    # neg_norm = torch.linalg.norm(neg_noise_pred, keepdim=True)
                    # noise_pred = uncon_noise_pred + (neg_noise_pred + noise_pred)/2 # / (2 * neg_norm) * original_norm
